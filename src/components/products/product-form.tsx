        ...
        <div className='h-min md:mt-16'>
            <div className='bg-white mx-auto mt-4 h-5/6 md:h-50vh w-90% xl:w-70% relative flex flex-col md:flex-row items-center rounded-lg border-2 border-neutral-200'>
                ...
                <div className='w-full p-5 md:w-70% h-full md:p-16 flex flex-col justify-between md:ml-3'>
                    ...
                    <p className='text-md my-4'>Rating: <span className='font-semibold'>{product.rating.rate}/5</span> (out of {product.rating.count})</p>
                    <div className='flex flex-col md:flex-row md:justify-end md:items-center items-end'>
                        <div className='flex flex-row items-center align-center pb-3 md:pb-0'>
                            <span className='font-semibold text-2xl  pr-5'>{product.price} {currency}</span>
                        ...
                        <div className='flex flex-row items-center md:pl-5'>
                            <button onClick={addItemToCart} className='m-2 ml-4 bg-neutral-200 rounded-md px-4 py-2 hover:bg-neutral-300 active:bg-neutral-400'>Add to cart</button>
                            <button onClick={removeItemFromCart} className='m-2 ml-4 bg-neutral-200 rounded-md px-4 py-2 hover:bg-neutral-300 active:bg-neutral-400 -order-1 md:order-1'>Remove product</button>
                        </div>
                    </div>
                </div>
            </div>
